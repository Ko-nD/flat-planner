...
- 🍳 **Готовые кухонные гарнитуры** — **9 шаблонов** в кнопке «⚡ Шаблоны»: 4 линейные (1.6 / 2.0 / 2.4 / 3.0 м) и 5 угловых (Г-образные 1.6×2.0 / 1.8×2.4 / 2.0×2.7 / 2.4×3.0, П-образная 1.8×2.4×1.8). Каждый шаблон одним кликом ставит 4-12 модулей: тумба под мойку + **газовая плита 60×60 на своём слоте** + шкафы + (для больших — холодильник, двойная мойка, шкаф-пенал, угловой 900×900). Размеры по сериям IKEA Method / Hoff / Леруа
