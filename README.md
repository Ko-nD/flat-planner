...
- 🍳 **Готовые кухонные гарнитуры** — 5 шаблонов (1.6 / 2.0 / 2.4 / 3.0 м линейные + Г-образная 1.6×2.0). Кнопка «⚡ Шаблоны» в тулбаре кладёт сразу 4-7 модулей в ряд: тумба под мойку + газовая плита 60×60 на своём слоте + шкафы. Размеры по сериям IKEA Method / Hoff. Для 3.0 м — со встроенным холодильником и двойной мойкой
